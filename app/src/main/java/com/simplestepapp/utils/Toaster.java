...
public class Toaster {
    ...
    public static void showWarningMessage(String msg) {
        Toasty.warning(App.getInstance(), msg, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showSuccessMessage(String msg) {
        Toasty.success(App.getInstance(), msg, Toast.LENGTH_SHORT).show();
    }

    public static void showInfoMessage(String msg) {
        Toasty.info(App.getInstance(), msg, Toast.LENGTH_SHORT).show();
    }
